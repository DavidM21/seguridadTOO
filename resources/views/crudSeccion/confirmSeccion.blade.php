...
@section('section', 'Eliminar Sección')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:">Eliminar sección</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-12">
        <div class="card Recent-Users">
            <div class="card-header unread">
                <h5>Eliminar Sección</h5>

            </div>
            <div class="card-body">
                <form  method="POST" action="{{ route('seccion.destroy', $section->id) }}">
                    @csrf @method('DELETE')
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('seccion.show')}}" type="button" class="btn btn-outline-danger">Cancelar</a>

                ...
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>
                            ...
                            src="{{asset('assets/images/user/avatar-1.jpg')}}" alt="activity-user">Ida Jorgensen</h6>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;"
                             src="{{asset('assets/images/user/avatar-2.jpg')}}" alt="activity-user">Albert Andersen</h6>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <h6 class="m-0"><img class="rounded-circle  m-r-10" style="width:40px;"
                             src="{{asset('assets/images/user/avatar-3.jpg')}}" alt="activity-user">Silje Larsen</h6>
                        </td>
                        <td>
            ...
            <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                <table class="table table-hover">
                    ...
                    <tr>
                        <td>
                            <h6 class="m-0"><img class="rounded-circle m-r-10" style="width:40px;"
                                                 src="{{asset('assets/images/user/avatar-3.jpg')}}" alt="activity-user">Ida Jorgensen</h6>
                        </td>
                        <td>
                            <h6 class="m-0">The quick brown fox</h6>
                        </td>

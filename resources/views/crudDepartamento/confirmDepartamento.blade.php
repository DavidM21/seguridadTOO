...
@section('section', 'Eliminar Departamento')
...
@section('content')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:">Eliminar departamento</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-12">
        <div class="card Recent-Users">
            ...
            <div class="card-body">
                <form  method="POST" action="{{ route('departamento.destroy', $department->id) }}">
                    @csrf @method('DELETE')
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <a href="{{ route('departamento.show')}}" type="button" class="btn btn-outline-danger">Cancelar</a>

...
<head>
    ...
    <!-- fontawesome icon -->
    <link rel="stylesheet" href="{{ URL::asset('assets/fonts/fontawesome/css/fontawesome-all.min.css')}}">
    <!-- animation css -->
    <link rel="stylesheet" href="{{ URL::asset('assets/plugins/animation/css/animate.min.css')}}">
    <!-- vendor css -->
